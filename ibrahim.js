...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*SHEIKH ALI MD WELCOME MESSAGE*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ SHEIKH-ALI-MD is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ SHEIKH-ALI-MD Connected to WhatsApp! ☺️");
                console.log("--");
                ...
                let cmsg =`      ❒─❒⁠⁠⁠⁠ *SHEIKH-ALI-MD Is Running* ❒⁠⁠⁠⁠─⁠⁠⁠⁠❒⁠⁠⁠⁠
╭❒⁠⁠⁠⁠─❒⁠⁠⁠⁠─❒⁠⁠⁠⁠─❒⁠⁠⁠⁠─❒⁠⁠⁠⁠              
❒⁠⁠⁠⁠ Owner  : *♥️🌸⃝𝐂𝐮𝐭𝐞 𝐬𝐡𝐞𝐢𝐤𝐡ᥫ᭡👑*   
❒⁠⁠⁠⁠ Machine : *SHEIKH-ALI-MD*
╰❒⁠⁠⁠⁠─❒⁠⁠⁠⁠─❒⁠⁠⁠⁠─❒⁠⁠⁠⁠─❒⁠⁠⁠⁠`;
