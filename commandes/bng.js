...
zokou({
  ...
  try {
    ...
    _0xc7214c.sendMessage(_0xd5693f, {
      ...
      'caption': "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𓄂𝕚𝕥𝕩.𝑺𝑯𝑬𝑰𝑲𝑯 𝑨𝑳𝑰 🔥༽༼*"
    }, {
      'quoted': _0x2b08ed
    });
  } catch (_0x247fd4) {
...
zokou({
  ...
  try {
    if (!_0x588900 || _0x588900.length === 0) {
      return _0x5e7c97("Please insert the image url SHEIKH-ALI-MD BOT will extract it for you.");
    }
...
zokou({
  ...
  try {
    if (!_0x2d283a || _0x2d283a.length === 0) {
      return _0x3baed4("Please describe your image and SHEIKH-ALI-MD BOT will generate it.");
    }
...
zokou({
  ...
  try {
    if (!_0x30c86a || _0x30c86a.length === 0) {
      return _0x16c607("Please describe your image SHEIKH-ALI-MD BOT will generate it.");
    }
...
zokou({
  ...
  try {
    if (!_0x380eb1 || _0x380eb1.length === 0) {
      return _0x64dfea("Please describe your image and SHEIKH-ALI-MD BOT will generate it.");
    }
...
zokou({
  ...
  try {
    if (!_0x4fe6fa || _0x4fe6fa.length === 0) {
      return _0x54668d("Kindly enter a valid image url and SHEIKH-ALI-MD BOT will beautify your image.");
    }
